...
function Stat({
  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white/70 backdrop-blur px-4 py-4 shadow-[0_12px_34px_-26px_rgba(17,17,17,0.55)] transition-transform hover:-translate-y-0.5">
      <div className="display-font text-2xl text-[color:var(--color-text-main)]">
        {value}
      </div>
      <div className="mt-1 text-[10px] uppercase tracking-[0.26em] text-[color:var(--color-muted)]">
        {label}
      </div>
    </div>
  );
...
export default function Offices() {
  ...
  return (
    <section id="ofis" className="relative py-20 sm:py-24 bg-[color:var(--color-bg-main)] overflow-hidden">
      ...
      <div className="container-shell relative z-10">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="display-font text-3xl sm:text-4xl md:text-5xl leading-tight text-[color:var(--color-text-main)]">
          ...
          <div className="relative rounded-[34px] border border-black/5 bg-white/75 backdrop-blur-xl shadow-[var(--shadow-main)] overflow-hidden">
            ...
            <div className="p-8 sm:p-10">
              ...
              <div className="mt-8 grid gap-4">
                <div className="rounded-[26px] border border-black/5 bg-[color:var(--color-bg-glass)] backdrop-blur p-6 shadow-[0_12px_34px_-28px_rgba(17,17,17,0.55)] animate-[fadeUp_520ms_ease-out]">
                  <Label>Manzil</Label>
                  <p className="display-font mt-2 text-xl sm:text-2xl font-semibold text-[color:var(--color-text-main)]">
                    {current.address}
                  </p>
                  ...
                  <div className="rounded-[26px] border border-black/5 bg-white/70 backdrop-blur p-6 shadow-[0_12px_34px_-28px_rgba(17,17,17,0.55)] animate-[fadeUp_600ms_ease-out]">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <a
                        ...
                        className="rounded-full bg-[color:var(--color-brand-primary)] px-5 py-3 text-[10px] font-bold uppercase tracking-[0.26em] text-white shadow-[0_10px_30px_-22px_rgba(17,17,17,0.45)] hover:brightness-[1.05] transition"
                      >
                        Qo‘ng‘iroq
                      </a>
                      <a
                        href="#aloqa"
                        className="rounded-full bg-white/70 border border-black/10 px-5 py-3 text-[10px] font-bold uppercase tracking-[0.26em] text-[color:var(--color-text-main)] hover:bg-white transition"
                      >
                        Yozish
                      </a>
                    </div>
